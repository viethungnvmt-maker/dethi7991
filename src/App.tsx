...
- Nếu thiếu bất kỳ câu nào, hãy tiếp tục viết cho đến khi đủ.`;
        ...
        if (generatedQuestionCount === effectiveQuestionCount) {
      ...
      throw new Error(`Đề thi AI tạo ra ${generatedQuestionCount} câu, nhưng ma trận/đặc tả yêu cầu ${effectiveQuestionCount} câu sau 3 lần thử. Vui lòng bấm tạo lại.`);
    } catch (error: any) {
      Swal.fire({
